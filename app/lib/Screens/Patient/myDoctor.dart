...
import 'package:dochub/Screens/Patient/chatDoctor.dart';
...
class MyDoctors extends StatefulWidget {
  Patient patient;
  MyDoctors({Key? key, required this.patient}) : super(key: key);
  @override
  _MyDoctorState createState() => _MyDoctorState();
}

class _MyDoctorState extends State<MyDoctors>{
  ...
  void initState() {
    ...
    _timer = Timer(
        const Duration(seconds: 1),
            () => {
          setState((){}), getMyDoctors(widget.patient.patientId.toString(), "All"),
        }
    );
  }
  @override
                            ...
                            child: DropdownButton<String>(
                              ...
                              onChanged: (Object? value) {
                                setState(() {
                                  ...
                                  getMyDoctors(widget.patient.patientId.toString(), department);
                                });
                              },
                                ...
                                trailing: GestureDetector(
                                  onTap: () {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                            builder: (context) => ChatDoctor(doctor: doctor[index], patient: widget.patient)));
                                  },
  ...
  void getMyDoctors(String id, String dept){
    showLoadingDoctors = true;
    ServerHandler().getMyDoctors(id, dept).then((value) => setState((){
