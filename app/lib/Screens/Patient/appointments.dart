...
import 'package:dochub/Screens/Patient/appointmentDetail.dart';
...
class Appointments extends StatefulWidget {
  Patient patient;
  Appointments({Key? key, required this.patient}) : super(key: key);
  @override
...
class _AppointmentsState extends State<Appointments> {
  ...
  bool showLoadingpreAppointment= true;
  @override
  void initState() {
    ...
    _timer = Timer(
        const Duration(seconds: 1),
          ...
          }), getAppointments(widget.patient.patientId.toString()),
        }
    );
  }
  @override
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AppointmentDetails(appointment: upappointments[index], patient: widget.patient,)));
                    },
                              ...
                              child: Column(
                                ...
                                children: [
                                  ListTile(
                                    leading: Container(
                                      height: 40,
                                      child: Image.network(ServerHandler().getImageUrl() + appointments[index].doctorImage.toString()),
                                    ),
                                    title: Row(
                                      children: [
                                        Text(upappointments[index].doctorName.toString(),
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodyText1!
                                                .copyWith(
                                    ...
                                    subtitle: Text(upappointments[index].doctorSpecialization.toString(),
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodyText2!
                                            .copyWith(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ListTile(
                                    leading: Container(
                                      height: 40,
                                      child: Image.network(ServerHandler().getImageUrl() + prevappointments[index].doctorImage.toString()),
                                    ),
                                    title: Row(
                                      children: [
                                        Text(prevappointments[index].doctorName.toString(),
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodyText1!
                                                .copyWith(
                                    ...
                                    subtitle: Text(prevappointments[index].doctorSpecialization.toString(),
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodyText2!
                                            .copyWith(
  ...
  getAppointments(String id) {
    showLoadingAppointment = true;
    ServerHandler().getAppointment(id).then((value) => setState((){
      appointments = value;
