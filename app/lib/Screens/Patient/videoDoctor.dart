...
class VideoDoctor extends StatefulWidget {
  Patient patient;
  Doctor doctor;
  VideoDoctor({Key? key, required this.patient, required this.doctor}) : super(key: key);
  @override
  _VideoDoctorState createState() => _VideoDoctorState();
}


class _VideoDoctorState extends State<VideoDoctor>{
