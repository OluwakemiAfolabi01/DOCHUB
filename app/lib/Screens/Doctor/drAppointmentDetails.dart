...
import 'package:dochub/Screens/Doctor/drAppointmentEdit.dart';
import 'package:dochub/Services/server_handler.dart';
import 'package:dochub/Theme/colors.dart';
import 'package:flutter/material.dart';
import 'package:fluttertoast/fluttertoast.dart';

class DRAppointmentDetails extends StatefulWidget {
  Appointment appointment;
  Doctor doctor;
  DRAppointmentDetails({Key? key, required this.appointment, required this.doctor}) : super(key: key);
  @override
  _DRAppointmentDetailsState createState() => _DRAppointmentDetailsState();
}


class _DRAppointmentDetailsState extends State<DRAppointmentDetails>{
                      ...
                      children: [
                        ListTile(
                          ...
                          leading: FadedScaleAnimation(
                            child: Container(
                              height: 40,
                              child: Image.network(ServerHandler().getImageUrl() + widget.appointment.patientImage.toString()),
                            ),
                        ...
                        ListTile(
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              Text(widget.appointment.doctorContact.toString(),
                                  style: Theme.of(context)
                                      .textTheme
                                      .bodyText2!
  ...
  void rescheduleAppointment(Appointment appointment) {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => DREditAppointment(appointment: widget.appointment, doctor: widget.doctor)));
  }
}
