...
class VoicePatient extends StatefulWidget {
  Patient patient;
  Doctor doctor;
  VoicePatient({Key? key, required this.patient, required this.doctor}) : super(key: key);
  @override
  _VoicePatientState createState() => _VoicePatientState();
}


class _VoicePatientState extends State<VoicePatient>{

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    updateMeetingStatus(widget.patient.patientId.toString(), widget.doctor.doctorId.toString(), "Virtual Voice Chat", "1");
  }
