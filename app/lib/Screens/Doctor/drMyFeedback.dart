...
class DRMyfeedbacks extends StatefulWidget {
  Doctor doctor;
  DRMyfeedbacks({Key? key, required this.doctor}) : super(key: key);
  @override
  _DRMyfeedbacksState createState() => _DRMyfeedbacksState();
}

class _DRMyfeedbacksState extends State<DRMyfeedbacks>{
  ...
  void initState() {
    ...
    _timer = Timer(
        const Duration(seconds: 1),
            () => {
          setState((){}), getFeedback(widget.doctor.doctorId.toString()),
        }
    );
  }
  @override
                    ...
                    child: Column(
                      children: [
                        ListTile(
                          ...
                          leading: Container(
                            height: 40,
                            child: Image.network(ServerHandler().getImageUrl()+feedback[index].patientImage.toString()),
                          ),
                          title: Row(
                            children: [
                              Row(
